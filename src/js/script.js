$(document).ready(function () {
    ...
    $('.carousel__inner').slick({
        ...
        speed: 1000,
        infinite: true,
        prevArrow: '<button type="button" class="slick-prev"><img src="img/icons/arrow-left-icon.svg"></button>',
        nextArrow: '<button type="button" class="slick-next"><img src="img/icons/arrow-right-icon.svg"></button>',
        responsive: [
            {
                breakpoint: 992,
                settings: {
